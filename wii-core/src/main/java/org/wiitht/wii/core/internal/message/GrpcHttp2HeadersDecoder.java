...
/**
 * @Author wii
 * @Date 18-12-13-下午7:07
 * @Version 1.0
 */
public class GrpcHttp2HeadersDecoder {
    public static class GrpcHttp2ServerHeadersDecoder extends DefaultHttp2HeadersDecoder {

        public GrpcHttp2ServerHeadersDecoder(long maxHeaderListSize) {
    ...
    public static class GrpcHttp2ClientHeadersDecoder extends DefaultHttp2HeadersDecoder {

        public GrpcHttp2ClientHeadersDecoder(long maxHeaderListSize) {
            super(true, maxHeaderListSize);
        }
...
final class GrpcHttp2ResponseHeaders extends GrpcHttp2InboundHeaders {
...
final class GrpcHttp2RequestHeaders extends GrpcHttp2InboundHeaders {
...
abstract class GrpcHttp2InboundHeaders extends AbstractHttp2Headers {
