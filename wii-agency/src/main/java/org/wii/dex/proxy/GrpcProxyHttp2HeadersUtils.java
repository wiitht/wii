 ...
 * @Version 1.0
 */
public class GrpcProxyHttp2HeadersUtils {
    static final class GrpcHttp2ServerHeadersDecoder extends DefaultHttp2HeadersDecoder {
        ...
        @Override
        protected GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders newHeaders() {
            return new GrpcProxyHttp2HeadersUtils.GrpcHttp2RequestHeaders(numberOfHeadersGuess());
        }
    }
    ...
    static final class GrpcHttp2ClientHeadersDecoder extends DefaultHttp2HeadersDecoder {
        ...
        @Override
        protected GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders newHeaders() {
            return new GrpcProxyHttp2HeadersUtils.GrpcHttp2ResponseHeaders(numberOfHeadersGuess());
        }
    }
     ...
     * {@link AsciiString}.
     */
    abstract static class GrpcHttp2InboundHeaders extends AbstractProxyHttp2Headers {
     ...
     */
    static final class GrpcHttp2RequestHeaders extends GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders {
        ...
        public Http2Headers add(CharSequence csName, CharSequence csValue) {
            ...
            if (equals(Utils.TE_HEADER, name)) {
                te = value;
                return this;
            }
        ...
        public String toString() {
            ...
            if (te != null) {
                appendNameAndValue(builder, Utils.TE_HEADER, te, prependSeparator);
            }
     ...
     */
    static final class GrpcHttp2ResponseHeaders extends GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders {
