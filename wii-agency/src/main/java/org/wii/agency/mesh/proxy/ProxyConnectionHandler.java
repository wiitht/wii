...
import org.wii.agency.mesh.common.DelimiterUtil;
import org.wii.agency.proxy.SendProxyFrameCommand;
import org.wii.agency.proxy.SendProxyHeaderCommand;
import org.wii.agency.proxy.Utils;
import org.wii.agency.proxy.WriteQueue;
import org.wii.agency.trail.*;
...
public class ProxyConnectionHandler extends ByteToMessageDecoder implements ChannelOutboundHandler {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        if (msg instanceof org.wii.agency.proxy.SendDataCommand) {
            org.wii.agency.proxy.SendDataCommand command = (org.wii.agency.proxy.SendDataCommand)msg;
    ...
    private final class FrameDecoder extends BaseDecoder {
        ...
        public void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
            try {
                ...
                GrpcProxyClient.sendData(new SendDataCommand(in));
                in.clear();
