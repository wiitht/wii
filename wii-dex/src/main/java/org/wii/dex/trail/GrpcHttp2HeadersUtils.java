...
import static org.wii.dex.proxy.Utils.TE_HEADER;
...
public class GrpcHttp2HeadersUtils {
    static final class GrpcHttp2ServerHeadersDecoder extends DefaultHttp2HeadersDecoder {
        ...
        protected GrpcHttp2HeadersUtils.GrpcHttp2InboundHeaders newHeaders() {
            return new GrpcHttp2HeadersUtils.GrpcHttp2RequestHeaders(numberOfHeadersGuess());
        }
    }
    ...
    static final class GrpcHttp2ClientHeadersDecoder extends DefaultHttp2HeadersDecoder {
        ...
        @Override
        protected GrpcHttp2HeadersUtils.GrpcHttp2InboundHeaders newHeaders() {
            return new GrpcHttp2HeadersUtils.GrpcHttp2ResponseHeaders(numberOfHeadersGuess());
        }
    }
    ...
    /**
     * A {@link GrpcHttp2HeadersUtils.GrpcHttp2InboundHeaders} implementation, optimized for HTTP/2 request headers. That
     ...
     */
    static final class GrpcHttp2RequestHeaders extends GrpcHttp2HeadersUtils.GrpcHttp2InboundHeaders {
     ...
     * other methods throw an {@link UnsupportedOperationException}.
     *
     * <p>Unlike in {@link GrpcHttp2HeadersUtils.GrpcHttp2ResponseHeaders} the {@code :status} pseudo-header is not treated
     * special and is part of {@link #namesAndValues}.
     */
    static final class GrpcHttp2ResponseHeaders extends GrpcHttp2HeadersUtils.GrpcHttp2InboundHeaders {
