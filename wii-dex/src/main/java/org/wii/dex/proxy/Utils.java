...
public class Utils {
    ...
    public static final SharedResourceHolder.Resource<EventLoopGroup> DEFAULT_BOSS_EVENT_LOOP_GROUP =
            new Utils.DefaultEventLoopGroupResource(1, "grpc-default-boss-ELG");

    public static final SharedResourceHolder.Resource<EventLoopGroup> DEFAULT_WORKER_EVENT_LOOP_GROUP =
            new Utils.DefaultEventLoopGroupResource(0, "grpc-default-worker-ELG");

    @VisibleForTesting
    static boolean validateHeaders = false;

    public static Metadata convertHeaders(Http2Headers http2Headers) {
        if (http2Headers instanceof GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders) {
            GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders h = (GrpcProxyHttp2HeadersUtils.GrpcHttp2InboundHeaders) http2Headers;
    ...
    public static Http2Headers convertClientHeaders(Metadata headers,
        ...
        return GrpcProxyHttp2OutboundHeaders.clientRequestHeaders(
    ...
    public static Http2Headers convertServerHeaders(Metadata headers) {
        ...
        return GrpcProxyHttp2OutboundHeaders.serverResponseHeaders(toHttp2Headers(headers));
    }
    ...
    public static Http2Headers convertTrailers(Metadata trailers, boolean headersSent) {
        ...
        return GrpcProxyHttp2OutboundHeaders.serverResponseTrailers(toHttp2Headers(trailers));
    }
   ...
   /* static Channelz.SocketOptions getSocketOptions(Channel channel) {
        ...
        NettySocketSupport.NativeSocketOptions nativeOptions
